...
public abstract class WindRender {
	...
	protected abstract String Wind_Render(MultiArray dataArray_1, MultiArray dataArray_2,
			int t, int l, double height2, double y222) throws IOException, InvalidRangeException;
...
//		return (int) (kk/1000);
	...
	public String Wind_Render(String Species_1, String Species_2,int t,int l, double height,double y22) throws IOException, InvalidRangeException{
		...
		return Wind_Render(dataArray_1,dataArray_2,t,l,height,y22);
	}
